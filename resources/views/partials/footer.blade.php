                        ...
                        <div class="container mil-p-120-60">
                            <div class="row justify-content-between">
                                <div class="col-md-4 col-lg-4 mil-mb-60">
                                    ...
                                    <div class="mil-muted mil-logo mil-up mil-mb-30">CreativeTech.</div>
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-6 col-lg-5 mil-mb-60">
                                            ...
                                            <p class="mil-light-soft mil-up">
                                                Sulawesi Tenggara, Kota Kendari<br>
                                                Kelurahan Kambu, Kecamatan Kambu<br>
                                                BTN Unhalu Blok L No 10
                                                <span class="mil-no-wrap">+62 812 3456 7890</span>
                                            </p>

                                        </div>
                                        <!-- Germany address removed as requested -->
                                    </div>
