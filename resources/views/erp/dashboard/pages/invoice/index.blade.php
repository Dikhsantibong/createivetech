...
@section('content')
		<!-- Left sidebar -->
        @include('erp.dashboard.partials.left-sidebar')
	
	<!-- Header Section Start -->
        @include('erp.dashboard.partials.header')
    <!--! ================================================================ !-->
    <!--! [Start] Main Content !-->
    <!--! ================================================================ !-->
    <main class="nxl-container">
                                    ...
                                    <table class="table table-hover" id="paymentList">
                                        ...
                                        <tbody>
                                            <tr class="single-item">
                                                ...
                                                <td><a href="invoice-view.php" class="fw-bold">#321456</a></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a href="invoice-view.php" class="avatar-text avatar-md">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="invoice-view.php" class="fw-bold">#987456</a></td>
                                                <td>
                                                    <a href="javascript:void(0)" class="hstack gap-3">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="invoice-view.php" class="fw-bold">#741258</a></td>
                                                <td>
                                                    <a href="javascript:void(0)" class="hstack gap-3">
                                                        <div class="avatar-image avatar-md">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="invoice-view.php" class="fw-bold">#357895</a></td>
                                                <td>
                                                    <a href="javascript:void(0)" class="hstack gap-3">
                                                        <div class="avatar-image avatar-md">
        ...
        <!-- [ Footer ] start -->
       @include('erp.dashboard.partials.footer')
        <!-- [ Footer ] end -->
    </main>
    <!--! ================================================================ !-->
    <!--! [End] Main Content !-->
	...
	<!--<< All JS Plugins >>-->
	@include('erp.dashboard.partials.homepage-script')	
