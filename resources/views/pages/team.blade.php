                        ...
                        <div class="row">
                                ...
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            ...
                                            <p class="mil-link mil-light-soft mil-mb-10">Marketing Leader</p>
                                            <ul class="mil-social-icons mil-center">
                                                <li>
                                                    <a href="https://www.instagram.com/USERNAME" target="_blank" class="social-icon">
                                                        <i class="fab fa-instagram"></i>
                                ...
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            ...
                                            <p class="mil-link mil-light-soft mil-mb-10">Creative Leader</p>
                                            <ul class="mil-social-icons mil-center">
                                                <li>
                                                    <a href="https://www.instagram.com/USERNAME" target="_blank" class="social-icon">
                                                        <i class="fab fa-instagram"></i>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            <h5 class="mil-muted mil-mb-5"><a href="home-2.html">Febri Nusa bakti</a></h5>
                                            <p class="mil-link mil-light-soft mil-mb-10">HR / Public Relations</p>
                                            <ul class="mil-social-icons mil-center">
                                                <li>
                                                    <a href="https://www.instagram.com/USERNAME" target="_blank" class="social-icon">
                                                        <i class="fab fa-instagram"></i>
