            ...
            <div class="mil-preloader-animation">
                ...
                <div class="mil-pos-abs mil-animation-2">
                    <div class="mil-reveal-frame">
                        ...
                        <p class="mil-h3 mil-muted mil-thin">ctechagency.io</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="container">
                            <div class="mil-banner-content mil-up">
                                ...
                                <h1 class="mil-muted mil-mb-60">
                                    Technology <span class="mil-thin">That Drives</span><br>
                                    Business <span class="mil-thin">Progress</span>
                                </h1>
                                
                                <div class="row">
                                    <div class="col-md-7 col-lg-5">
                                        <p class="mil-light-soft mil-mb-60">
                                            We deliver reliable and scalable digital solutions, helping organizations
                                            innovate, grow, and succeed in an increasingly connected world.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-xl-5">
                                ...
                                <div class="mil-mb-90">
                                    <h2 class="mil-up mil-mb-60">
                                        Discover <br>
                                        Our <span class="mil-thin">Company</span>
                                    </h2>
                            
                                    <p class="mil-up mil-mb-30">
                                        CreativeTech is a technology-driven company focused on delivering
                                        reliable and impactful digital solutions. We combine strategic thinking,
                                        technical expertise, and industry best practices to support our clients’
                                        long-term business objectives.
                                    </p>
                            
                                    <p class="mil-up mil-mb-60">
                                        Our team works collaboratively to design, develop, and implement systems
                                        that are secure, scalable, and aligned with real-world operational needs.
                                        Through a structured and results-oriented approach, we ensure every
                                    ...
                                    <div class="mil-about-quote">
                                        ...
                                        <h6 class="mil-quote mil-up">
                                            ...
                                            for Sustainable <span class="mil-thin">Business Growth</span>
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="mil-about-photo mil-mb-90">
                                    ...
                                    <div class="mil-up mil-img-frame" style="padding-bottom: 160%;">
                                        <img src="{{ asset('ashley/img/logo/hero.png') }}" alt="Founder" class="mil-scale" data-value-1="1" data-value-2="1.2">
                                    </div>
                                </div>
                ...
                <div class="mil-soft-bg">
                    <div class="container mil-p-0-120">
                        ...
                        <div class="swiper-container mil-infinite-show mil-up">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="{{ asset('ashley/img/partners/1.png') }}" class="mil-partner-frame" style="width: 60px;"><img src="{{ asset('ashley/img/partners/1.png') }}" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('ashley/img/partners/2.png') }}" class="mil-partner-frame" style="width: 100px;"><img src="{{ asset('ashley/img/partners/2.png') }}" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('ashley/img/partners/1.png') }}" class="mil-partner-frame" style="width: 60px;"><img src="{{ asset('ashley/img/partners/1.png') }}" alt="logo"></a>
                                </div>
