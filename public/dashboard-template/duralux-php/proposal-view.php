                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled text-muted mb-0">
                                            ...
                                            <li class="d-flex align-items-start mb-3">
                                                ...
                                                <span>Utilized.php, CSS, and JavaScript to create 100+ responsive landing pages for both company and client. </span>
                                            </li>
                                            <li class="d-flex align-items-start mb-3">
                                                <span class="avatar-text avatar-sm bg-soft-success text-success me-3">
                                                    <i class="feather-check fs-10"></i>
                                ...
                                <div class="card stretch stretch-full">
                                    ...
                                    <div class="card-body task-checklist">
                                        <ul class="list-unstyled" id="checklist">
                                            ...
                                            <li>Utilized.php, CSS, and JavaScript to create 100+ responsive landing pages for both company and client.</li>
                                            <li class="checked">Rewrote.php to meet industry and company standards for SEO and Accessibility.</li>
