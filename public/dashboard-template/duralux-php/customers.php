                                    ...
                                    <table class="table table-hover" id="customerList">
                                        ...
                                        <tbody>
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <a href="customers-view.php" class="hstack gap-3">
                                                ...
                                                <td><a href="apps-email.php">alex.della@outlook.com</a></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a href="customers-view.php" class="avatar-text avatar-md">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">nancy.elliot@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                                        <option value="success" data-bg="bg-success">VIP</option>
                                                        <option value="info" data-bg="bg-info">Bugs</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">green.cute@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                                        <option value="success" data-bg="bg-success">VIP</option>
                                                        <option value="info" data-bg="bg-info">Bugs</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">henry.leach@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                                        <option value="success" data-bg="bg-success">VIP</option>
                                                        <option value="info" data-bg="bg-info">Bugs</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">marine.adrey@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                                        <option value="success" data-bg="bg-success">VIP</option>
                                                        <option value="info" data-bg="bg-info">Bugs</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">cute.green@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">leach.henry@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                                        <option value="success" data-bg="bg-success" selected>VIP</option>
                                                        <option value="info" data-bg="bg-info" selected>Bugs</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">adrey.marine@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                                        <option value="success" data-bg="bg-success">VIP</option>
                                                        <option value="info" data-bg="bg-info" selected>Bugs</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-email.php">elliot.nancy@outlook.com</a></td>
                                                <td>
                                                    <select class="form-select form-control max-select" data-select2-selector="tag" data-max-select2="tag" multiple>
                                                        <option value="success" data-bg="bg-success">VIP</option>
                                                        <option value="info" data-bg="bg-info">Bugs</option>
