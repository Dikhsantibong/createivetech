                ...
                <div class="content-sidebar content-sidebar-md" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-sidebar-body">
                        <ul class="nav flex-column nxl-content-sidebar-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="settings-finance.php">
                                    <i class="feather-dollar-sign"></i>
                                    <span>Finance</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="settings-gateways.php">
                                    <i class="feather-git-branch"></i>
                                    <span>Gateways</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="settings-customers.php">
                                    <i class="feather-users"></i>
                                    <span>Customers</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="settings-localization.php">
                                    <i class="feather-globe"></i>
                                    <span>Localization</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="settings-recaptcha.php">
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-0">
                                    <label class="form-label">Customer Information Format (PDF and.php)</label>
                                    <textarea class="form-control" cols="30" rows="10" placeholder="{company_name}
{street}
{city} {state}
{country_code} {zip_code}
{vat_number_with_label}"></textarea>
                                    <small class="form-text text-muted">Customer Information Format (PDF and.php) [Ex: {company_name}, {customer_id}, {street}, {city}, {state}, {zip_code}, {country_code}, {country_name}, {phone}, {vat_number}, {vat_number_with_label}]</small>
                                </div>
                            </div>
                        </div>
                    </div>
