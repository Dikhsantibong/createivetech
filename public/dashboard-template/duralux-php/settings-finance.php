                ...
                <div class="content-sidebar content-sidebar-md" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-sidebar-body">
                        <ul class="nav flex-column nxl-content-sidebar-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="settings-finance.php">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="settings-customers.php">
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-0">
                                    <label class="form-label">Proposal Info Format (PDF and.php)</label>
...
{phone}
{email}"></textarea>
                                    <small class="form-text text-muted">Proposal Info Format (PDF and.php) [Ex: {proposal_to} {address} {city} {state} {country_code} {zip_code} {phone} {email}]</small>
                                </div>
                            </div>
                        </div>
                    </div>
